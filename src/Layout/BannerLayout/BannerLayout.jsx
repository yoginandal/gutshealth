  ...
  return (
    <div className="flex flex-col justify-center items-center py-20 px-5 text-center">
      ...
      <p className="text-xl lg:text-2xl text-gray-500 italic mb-8 max-w-3xl">
        ...
        <span className="text-yellow-600 font-semibold">health</span> meets{" "}
        <span className="text-yellow-600 font-semibold">elegance</span>.
        Discover personalized solutions tailored just for you.
      </p>
